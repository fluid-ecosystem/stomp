...
async function main() {
  try {
    ...
    console.log('🔌 [TypeScript] Connecting to C++ server...');
    
    client.setConnectionListener((connected, reason) => {
      if (connected) {
        console.log('✅ [TypeScript] Connected to C++ server!');
    ...
    // Send test messages
    console.log('📤 [TypeScript] Sending messages to C++ server...');
    client.send('/queue/cross-test', 'Hello C++ from TypeScript!');
    ...
    console.log('🎉 [TypeScript] Cross-language test with C++ server completed successfully!');
