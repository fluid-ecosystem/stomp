...
// Simple StompFrame utilities (same as CppServerTest.js)
class StompFrame {
...
async function main() {
  try {
    ...
    console.log('🔌 [TypeScript] Connecting to Java server...');
    
    client.setConnectionListener((connected, reason) => {
      if (connected) {
        console.log('✅ [TypeScript] Connected to Java server!');
    ...
    // Send test messages
    console.log('📤 [TypeScript] Sending messages to Java server...');
    client.send('/queue/cross-test', 'Hello Java from TypeScript!');
    ...
    console.log('🎉 [TypeScript] Cross-language test with Java server completed successfully!');
