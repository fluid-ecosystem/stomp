...
public class TsServerTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("🔌 [Java] Connecting to TypeScript server...");
            CompletableFuture<Void> connectFuture = client.connect();
            
            // Wait for connection with timeout
            connectFuture.get(10, TimeUnit.SECONDS);
            System.out.println("✅ [Java] Connected to TypeScript server!");
            ...
            // Send test messages
            System.out.println("📤 [Java] Sending messages to TypeScript server...");
            client.send("/queue/cross-test", "Hello TypeScript from Java!");
            ...
            System.out.println("🎉 [Java] Cross-language test with TypeScript server completed successfully!");
